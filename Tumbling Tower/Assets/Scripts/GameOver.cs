...
public class GameOver : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        SaveManager.instance.LifetimeScore += PlayerPrefs.GetInt("CurrentScore",0);
        if (PlayerPrefs.GetInt("CurrentScore",0) > 10)
        {
            SaveManager.instance.Credits += PlayerPrefs.GetInt("CurrentScore",0) -10;  
            SaveManager.instance.TotalCredits += PlayerPrefs.GetInt("CurrentScore",0) -10;          
        }
